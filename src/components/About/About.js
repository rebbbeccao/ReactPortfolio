      ...
      <div className="text-cushion">
        <div className="text">
          <p>
            ...
            ES6, CSS, CSS-grid, Handlebars, JQuery, Media Queries, RESTful APIs,
            JSON, SQL, Sequelize, Mongo, Mongoose, node.js.
          </p>
          <p>
            With a heavy background in hairspray, dance, and year-round training
            for cheer competitions; I fiercely enter the tech industry. (Dun dun
            dun...)
          </p>
          <p>
